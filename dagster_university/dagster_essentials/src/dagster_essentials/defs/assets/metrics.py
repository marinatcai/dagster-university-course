...
def trips_by_week(context: dg.AssetExecutionContext, database: DuckDBResource) -> None:
    """
      Generate and save the number of trips per week, aggregated by week, as CSV file 
    """
  
    # Option when we have partitions and want to use the partition date
    ...
    #Option when we do not have partitions and want to hardcode the date range
    # Date Range Setup
